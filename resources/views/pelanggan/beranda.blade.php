    ...
    <div class="col-span-2">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div class="flex items-center justify-between mb-5">
                ...
                <a href="{{ route('pelanggan.voucher.index') }}" class="text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 px-4 py-2 rounded-lg transition-colors">
                    Lihat semua
                </a>
            </div>
            ...
            @else
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <a href="{{ route('pelanggan.voucher.show', $v) }}" class="block p-4 border border-gray-200 rounded-xl hover:border-gray-400 transition-colors text-center group">
                        <div class="text-xs font-medium text-gray-500 mb-2 truncate">{{ $v->kategori?->nama_kategori }}</div>
    ...
    <div class="col-span-1">
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm h-full">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start gap-3 relative pb-4 {{ !$loop->last ? 'border-b border-gray-100' : '' }}">
                    <div class="w-2 h-2 rounded-full mt-1.5 flex-shrink-0 {{ $notif['aktif'] ? 'bg-blue-500' : 'bg-gray-300' }}"></div>
                    <div>
                ...
                @if($voucherTerpakai->isNotEmpty())
                    ...
                    <div class="flex items-start gap-3 relative pb-4">
                        ...
                        <div>
                            <p class="text-sm text-gray-800 leading-relaxed">Voucher {{ $lastTerpakai->kode_voucher }} berhasil digunakan</p>
