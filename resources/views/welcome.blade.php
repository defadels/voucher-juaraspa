...
<head>
    ...
    <meta name="description"
        content="Juara Spa Medan. Tempat terbaik untuk treatment massage dan reflexology di Medan, Indonesia. Terapis profesional dengan layanan berkualitas tinggi.">
...
<body
    class="bg-[#F6EFDE] text-[#2A2421] min-h-screen flex flex-col antialiased selection:bg-[#C5A059] selection:text-white">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
            ...
            <a href="/" class="flex items-center gap-3 group">
                ...
                <div class="hidden sm:block">
                    <span
                        class="block font-serif-juara text-lg sm:text-xl font-bold tracking-widest text-[#2A2421]">JUARA
                        SPA</span>
    ...
    <section class="relative w-full bg-[#FAF6ED] pt-8 pb-16 border-b border-[#E8DFC9]">
        <div class="max-w-5xl mx-auto px-4 text-center">
            ...
            <div
                class="relative w-full max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-2xl mb-10 border border-[#E8DFC9]">
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-t from-[#2A2421]/70 via-[#2A2421]/20 to-transparent flex items-end justify-center pb-8">
                    <span
                        class="text-white text-xs sm:text-sm tracking-widest uppercase bg-black/40 px-5 py-2 rounded-full backdrop-blur-sm border border-white/20 shadow-md">
            ...
            <div class="max-w-2xl mx-auto text-[#635752] text-sm sm:text-base leading-relaxed space-y-4 font-normal">
                <p>
                    <span class="font-semibold text-[#2A2421]">'The City Escape'</span> or <span
                        class="font-semibold text-[#2A2421]">'The New World'</span> - choice is all yours. We are just
                    very excited to see you!
                </p>
                <p class="text-xs sm:text-sm italic text-[#877871] pt-2 border-t border-[#E8DFC9]/70 max-w-xl mx-auto">
                    Juara Spa was previously known as Ras Spa. We opened our doors to our customers in 2008 and we have
                    since thrived to be the best in the industry. So we changed our brand name to
                    <strong>'Juara'</strong> which means <em>'the victor'</em>, just as we truly are.
                </p>
            </div>
    ...
    <section class="py-16 bg-[#F6EFDE] border-b border-[#E8DFC9]">
        <div class="max-w-5xl mx-auto px-4">
            <div
                class="bg-[#FAF6ED] rounded-2xl p-8 sm:p-12 border border-[#E8DFC9] shadow-lg flex flex-col md:flex-row items-center gap-8">
                <div class="flex-1 space-y-4">
                    <span
                        class="text-xs font-bold uppercase tracking-widest text-[#9E7B3B] bg-[#F6EFDE] px-3 py-1 rounded-full border border-[#E8DFC9]">
                        Exclusive Retreat
                    </span>
                    ...
                    <div class="pt-4 flex flex-wrap gap-4">
                        @if (Route::has('pelanggan.login'))
                            <a href="{{ route('pelanggan.login') }}"
                                class="px-6 py-3 bg-[#9E7B3B] hover:bg-[#85652D] text-white text-sm font-semibold rounded-full shadow-md transition-all">
                                Gunakan / Cek Voucher Spa
                            </a>
                        @endif
                        <a href="https://wa.me/6285266206336" target="_blank"
                            class="px-6 py-3 bg-[#25D366] hover:bg-[#1EBE5A] text-white text-sm font-semibold rounded-full shadow-md transition-all flex items-center gap-2">
                ...
                <div
                    class="w-full md:w-80 h-72 rounded-xl overflow-hidden shadow-md border border-[#E8DFC9] group relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                ...
                <div class="bg-[#F6EFDE] p-6 rounded-xl border border-[#E8DFC9] shadow-sm space-y-3">
                    ...
                    <p class="text-sm text-[#635752] leading-relaxed">
                        We're experts at what we do. But knowing the best techniques is only part of the process, we're
                        also here to make you feel great. Whether you're here for a one-hour service or an entire day,
                        your peace and joy is of utmost importance!
                    </p>
                </div>
                <!-- Card 2 -->
                <div class="bg-[#F6EFDE] p-6 rounded-xl border border-[#E8DFC9] shadow-sm space-y-3">
                    ...
                    <p class="text-sm text-[#635752] leading-relaxed">
                        From the moment you walk in any of our doors, our focus is on your complete relaxation. From
                        massage to reflexology, our services are a great way to take a step back from the bustle of
                        everyday city life. Come take a break and leave our doors totally refreshed!
                    </p>
                </div>
                <!-- Card 3 -->
                <div class="bg-[#F6EFDE] p-6 rounded-xl border border-[#E8DFC9] shadow-sm space-y-3">
                    ...
                    <p class="text-sm text-[#635752] leading-relaxed">
                        Many people underestimate the effect high-quality lotions and oils have on a spa treatment. We
                        guarantee our all-natural products help you with that extra feeling of zen and complete
                        revitalization of all your senses!
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-[#F6EFDE] border-b border-[#E8DFC9]">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Treatment 1 -->
                <div
                    class="bg-[#FAF6ED] rounded-xl overflow-hidden border border-[#E8DFC9] shadow-md hover:shadow-xl transition-all flex flex-col group">
                    <div class="h-48 overflow-hidden relative">
                        <img src="{{ asset('open-message.jpeg') }}" alt="Juara Massage Treatment"
                            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        <span
                            class="absolute top-3 right-3 text-xs bg-[#9E7B3B] text-white px-3 py-1 rounded-full font-semibold shadow">
                            2 Jam
                        </span>
                    </div>
                    <div class="p-6 flex-1 flex flex-col justify-between">
                        <div>
                            <h3 class="font-serif-juara text-xl font-bold text-[#2A2421] uppercase mb-1">JUARA MASSAGE
                            </h3>
                            <p class="text-xs text-[#9E7B3B] mb-3 font-semibold">With Olive Oil</p>
                            <p class="text-sm text-[#635752] leading-relaxed mb-4">
                                Terinspirasi dari Javanese massage, treatment ini dipercaya dapat membantu mengurangi
                                kelelahan pada otot serta membantu memperlancar peredaran darah.
                            </p>
                        </div>
                        <div
                            class="pt-3 border-t border-[#E8DFC9] flex justify-between items-center text-xs text-[#9E7B3B]">
                ...
                <div
                    class="bg-[#FAF6ED] rounded-xl overflow-hidden border border-[#E8DFC9] shadow-md hover:shadow-xl transition-all flex flex-col group">
                    <div class="h-48 overflow-hidden relative">
                        <img src="{{ asset('thai.jpeg') }}" alt="Thai Herbal Treatment"
                            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        <span
                            class="absolute top-3 right-3 text-xs bg-[#9E7B3B] text-white px-3 py-1 rounded-full font-semibold shadow">
                            2 Jam
                    ...
                    <div class="p-6 flex-1 flex flex-col justify-between">
                        <div>
                            <h3 class="font-serif-juara text-xl font-bold text-[#2A2421] uppercase mb-1">THAI HERBAL
                            </h3>
                            <p class="text-xs text-[#9E7B3B] mb-3 font-semibold">1 Jam Oil Massage + 1 Jam Thai Herbal
                            </p>
                            <p class="text-sm text-[#635752] leading-relaxed mb-4">
                                Perawatan massage yang diciptakan untuk Anda yang sedang mengalami masalah pernapasan &
                                kelelahan tubuh. Aroma hangat memanjakan tubuh dan pikiran.
                            </p>
                        </div>
                        <div
                            class="pt-3 border-t border-[#E8DFC9] flex justify-between items-center text-xs text-[#9E7B3B]">
                ...
                <div
                    class="bg-[#FAF6ED] rounded-xl overflow-hidden border border-[#E8DFC9] shadow-md hover:shadow-xl transition-all flex flex-col group">
                    <div class="h-48 overflow-hidden relative">
                        <img src="{{ asset('warm-stone.jpeg') }}" alt="Warm Stone Treatment"
                            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        <span
                            class="absolute top-3 right-3 text-xs bg-[#9E7B3B] text-white px-3 py-1 rounded-full font-semibold shadow">
                            2 Jam
                    ...
                    <div class="p-6 flex-1 flex flex-col justify-between">
                        <div>
                            <h3 class="font-serif-juara text-xl font-bold text-[#2A2421] uppercase mb-1">WARM STONE
                            </h3>
                            <p class="text-xs text-[#9E7B3B] mb-3 font-semibold">1 Jam Oil Massage + 1 Jam Warm Stone
                            </p>
                            <p class="text-sm text-[#635752] leading-relaxed mb-4">
                                Menggunakan batu hangat pada titik-titik akupresur. Sangat cocok untuk melepaskan
                                jet-lag atau kelelahan setelah perjalanan jauh.
                            </p>
                        </div>
                        <div
                            class="pt-3 border-t border-[#E8DFC9] flex justify-between items-center text-xs text-[#9E7B3B]">
                ...
                <div
                    class="bg-[#FAF6ED] rounded-xl overflow-hidden border border-[#E8DFC9] shadow-md hover:shadow-xl transition-all flex flex-col group">
                    <div class="h-48 overflow-hidden relative">
                        <img src="{{ asset('body-scrub.webp') }}" alt="Body Scrub Treatment"
                            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        <span
                            class="absolute top-3 right-3 text-xs bg-[#9E7B3B] text-white px-3 py-1 rounded-full font-semibold shadow">
                            2 Jam
                    ...
                    <div class="p-6 flex-1 flex flex-col justify-between">
                        <div>
                            <h3 class="font-serif-juara text-xl font-bold text-[#2A2421] uppercase mb-1">BODY SCRUB
                            </h3>
                            <p class="text-xs text-[#9E7B3B] mb-3 font-semibold">75 Min Massage + 45 Min Bengkoang
                                Scrub</p>
                            <p class="text-sm text-[#635752] leading-relaxed mb-4">
                                Menggunakan bahan rempah bengkoang murni untuk mencerahkan kulit, mengangkat sel kulit
                                mati, dan mempercepat regenerasi sel kulit baru.
                            </p>
                        </div>
                        <div
                            class="pt-3 border-t border-[#E8DFC9] flex justify-between items-center text-xs text-[#9E7B3B]">
                ...
                <div
                    class="bg-[#FAF6ED] rounded-xl overflow-hidden border border-[#E8DFC9] shadow-md hover:shadow-xl transition-all flex flex-col group">
                    <div class="h-48 overflow-hidden relative">
                        <img src="{{ asset('reflexology.jpeg') }}" alt="Reflexology Treatment"
                            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        <span
                            class="absolute top-3 right-3 text-xs bg-[#9E7B3B] text-white px-3 py-1 rounded-full font-semibold shadow">
                            90 Menit
                    ...
                    <div class="p-6 flex-1 flex flex-col justify-between">
                        <div>
                            <h3 class="font-serif-juara text-xl font-bold text-[#2A2421] uppercase mb-1">REFLEXOLOGY
                            </h3>
                            <p class="text-xs text-[#9E7B3B] mb-3 font-semibold">Foot & Calf Reflexology</p>
                            <p class="text-sm text-[#635752] leading-relaxed mb-4">
                                Dikhususkan pada bagian titik refleks telapak kaki dan betis untuk meredakan ketegangan
                                dan mengurangi rasa lelah pada kaki Anda.
                            </p>
                        </div>
                        <div
                            class="pt-3 border-t border-[#E8DFC9] flex justify-between items-center text-xs text-[#9E7B3B]">
                ...
                <div
                    class="bg-[#FAF6ED] rounded-xl overflow-hidden border border-[#E8DFC9] shadow-md hover:shadow-xl transition-all flex flex-col group">
                    <div class="h-48 overflow-hidden relative">
                        <img src="{{ asset('v-spa.jpeg') }}" alt="V-Spa Feminine Care"
                            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        <span
                            class="absolute top-3 right-3 text-xs bg-[#9E7B3B] text-white px-3 py-1 rounded-full font-semibold shadow">
                            1.5 Jam
                    ...
                    <div class="p-6 flex-1 flex flex-col justify-between">
                        <div>
                            ...
                            <p class="text-sm text-[#635752] leading-relaxed mb-4">
                                Perawatan khusus organ intim wanita menggunakan racikan rempah-rempah tradisional untuk
                                menjaga kesegaran, kebersihan, dan kenyamanan.
                            </p>
                        </div>
                        <div
                            class="pt-3 border-t border-[#E8DFC9] flex justify-between items-center text-xs text-[#9E7B3B]">
    ...
    <section class="py-14 bg-[#2A2421] text-[#F6EFDE] relative overflow-hidden">
        <div class="absolute inset-0 opacity-10 pointer-events-none">
            <img src="https://images.unsplash.com/photo-1600334129128-685c5582fd35?auto=format&fit=crop&w=1200&q=80"
                alt="Spa Background Texture" class="w-full h-full object-cover">
        </div>
        <div class="max-w-4xl mx-auto px-4 text-center space-y-6 relative z-10">
            <span
                class="text-xs font-semibold uppercase tracking-widest bg-[#9E7B3B] text-white px-3 py-1 rounded-full">
            ...
            <p class="text-sm sm:text-base text-[#D4C8B8] max-w-2xl mx-auto leading-relaxed">
                Nikmati kemudahan mengakses voucher spa digital milik Anda, cek riwayat penggunaan, dan tunjukkan QR
                Code voucher langsung ke staf resepsionis kami saat berkunjung.
            </p>
            <div class="pt-2 flex justify-center gap-4">
                @if (Route::has('pelanggan.login'))
                    <a href="{{ route('pelanggan.login') }}"
                        class="px-8 py-3.5 bg-[#9E7B3B] hover:bg-[#C5A059] text-white text-sm font-semibold rounded-full shadow-lg transition-all">
    ...
    {{-- <section class="py-16 bg-[#FAF6ED] border-b border-[#E8DFC9]">
        <div class="max-w-5xl mx-auto px-4 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Testimonial 1 -->
                <div
                    class="bg-[#F6EFDE] p-6 rounded-xl border border-[#E8DFC9] shadow-sm flex flex-col justify-between">
                ...
                <div
                    ...
                    <div class="pt-4 border-t border-[#E8DFC9] flex items-center gap-3">
                        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80"
                            alt="Reffy Nugraha" class="w-11 h-11 rounded-full object-cover border border-[#9E7B3B]">
                        <div class="text-left">
                ...
                <div
                    ...
                    <div class="pt-4 border-t border-[#E8DFC9] flex items-center gap-3">
                        <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&q=80"
                            alt="Djohan Chandra" class="w-11 h-11 rounded-full object-cover border border-[#9E7B3B]">
                        <div class="text-left">
    ...
    <section class="py-16 bg-[#F6EFDE] border-b border-[#E8DFC9]">
        <div class="max-w-5xl mx-auto px-4 text-center">
            ...
            <div class="grid grid-cols-1 gap-8 text-left">
                ...
                <div class="bg-[#FAF6ED] rounded-xl overflow-hidden border border-[#E8DFC9] shadow-sm space-y-3">
                    <div class="h-40 overflow-hidden">
                        <img src="{{ asset('location.jpeg') }}" alt="Ringroad City Escape"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="p-5 pt-2 space-y-2">
                        <span
                            class="text-[10px] font-bold uppercase tracking-widest text-[#9E7B3B] bg-[#F6EFDE] px-2.5 py-0.5 rounded-full border border-[#E8DFC9]">
                            RINGROAD
                        </span>
                        <h3 class="font-serif-juara font-bold text-lg text-[#2A2421] uppercase">
                            THE CITY ESCAPE
                        </h3>
                        <p class="text-md text-[#635752] leading-relaxed">
                ...
                {{-- <div class="bg-[#FAF6ED] rounded-xl overflow-hidden border border-[#E8DFC9] shadow-sm space-y-3">
                    <div class="h-40 overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1596178065887-1198b6148b2b?auto=format&fit=crop&w=600&q=80"
                            alt="Escape to the New World" class="w-full h-full object-cover">
                    </div>
                    <div class="p-5 pt-2 space-y-2">
                        <span
                            class="text-[10px] font-bold uppercase tracking-widest text-[#9E7B3B] bg-[#F6EFDE] px-2.5 py-0.5 rounded-full border border-[#E8DFC9]">
                        ...
                        <p class="text-xs text-[#635752] leading-relaxed">
                            Our newest facility! Just a short drive away from the busy city into heaven on earth
                            surrounded by nature sounds & scents.
                        </p>
                    </div>
                </div> --}}
            </div>
    ...
    <footer class="bg-[#2A2421] text-[#F6EFDE] pt-12 pb-8 border-t border-[#4A3E3D]">
        <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10 pb-10 border-b border-[#4A3E3D]">
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-3">
                    <img src="//img1.wsimg.com/isteam/ip/54b668da-c235-4693-bbbd-33ebef8f78e9/Juara%20General%20Big.png/:/rs=h:120/qt=q:95"
                        alt="Juara Spa" class="h-10 w-auto">
                ...
                <p class="text-xs text-[#D4C8B8] leading-relaxed max-w-md">
                    The best place for massage and reflexology treatments in Medan, Indonesia. Professionally trained
                    therapists & complete revitalization of all your senses.
                </p>
                <div class="space-y-1.5 text-xs text-[#D4C8B8] pt-2">
                    <p class="flex items-center gap-2">
                        <span class="font-semibold text-white">Telepon / WA:</span>
                        <a href="tel:085266206336" class="hover:text-[#C5A059] transition-colors">085266206336</a>
                    </p>
                    <p class="flex items-center gap-2">
                        <span class="font-semibold text-white">Email:</span>
                        <a href="mailto:juaraspa11@gmail.com"
                            class="hover:text-[#C5A059] transition-colors">juaraspa11@gmail.com</a>
                    </p>
                    <p class="flex items-center gap-2">
                        <span class="font-semibold text-white">Instagram:</span>
                        <a href="https://www.instagram.com/juaraspa" target="_blank"
                            class="hover:text-[#C5A059] transition-colors">@juaraspa</a>
                    </p>
                </div>
            </div>
            ...
            <div class="bg-[#382F2D] p-6 rounded-xl border border-[#4A3E3D] flex flex-col justify-between space-y-4">
                <div>
                    <h3 class="font-serif-juara font-bold text-lg text-white mb-2">Reservasi & Pertanyaan Treatment
                    </h3>
                ...
                <a href="https://wa.me/6285266206336" target="_blank"
                    class="w-full py-3 bg-[#25D366] hover:bg-[#1EBE5A] text-white text-xs sm:text-sm font-semibold rounded-full text-center transition-all flex items-center justify-center gap-2 shadow-lg">
                    <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24">
                        <path
                            d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 3.891 1.746 5.634l-.999 3.648 3.742-.981z" />
                    </svg>
        ...
        <div
            class="max-w-6xl mx-auto px-4 pt-6 flex flex-col sm:flex-row items-center justify-between text-[11px] text-[#877871]">
