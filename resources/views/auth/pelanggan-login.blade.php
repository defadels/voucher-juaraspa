...
<body class="font-sans bg-[#f5f5f0] flex h-screen">

    {{-- LEFT SIDEBAR --}}
    <aside class="w-[250px] min-w-[250px] bg-[#1a1a1a] text-white flex flex-col justify-between py-8 px-6">
        <div>
            <div class="mb-12">
            ...
            <div class="space-y-5">
                @foreach([
                    ['icon' => 'qr', 'title' => 'Voucher Digital Aman', 'desc' => 'Tersimpan di smartphone, tidak hilang atau rusak'],
                    ['icon' => 'mail', 'title' => 'QR Code Unik', 'desc' => 'Setiap voucher tidak bisa dipalsukan'],
                    ['icon' => 'clock', 'title' => 'Riwayat Lengkap', 'desc' => 'Pantau semua voucher aktif dan terpakai'],
                ] as $item)
                <div class="flex items-start gap-3">
                    <div class="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <svg class="w-4 h-4 text-white/70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                        @else
                        <svg class="w-4 h-4 text-white/70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        @endif
                    </div>
                    <div>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="mb-5 p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800">
                <div class="flex items-start gap-2">
                    ...
                    <span><strong>Informasi</strong><br>Akun dibuat oleh admin Juara SPA. Belum punya akun? Hubungi Juara SPA di <strong>0812-xxxx-xxxx</strong></span>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('pelanggan.login') }}" class="space-y-5">
                ...
                <div>
                    <label class="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1.5" for="login">
                        Email / No. Telepon
                    </label>
                    <input
                        id="login"
                ...
                <div>
                    <label class="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1.5" for="password">
                        Password
                    </label>
                    <input
                        id="password"
            ...
            <p class="mt-5 text-center text-sm text-gray-500">
                Admin?
                <a href="{{ route('admin.login') }}" class="underline text-gray-700 hover:text-gray-900">
