...
@section('page-title', 'Tambah Kategori Voucher')
...
<div class="max-w-xl">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <form action="{{ route('admin.kategori-voucher.store') }}" method="POST" class="p-6 space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="prefix" id="prefix" required maxlength="3" value="{{ old('prefix') }}"
                    placeholder="Contoh: BS2"
            ...
            <div>
                ...
                <textarea name="deskripsi" id="deskripsi" rows="3"
                    class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-400 transition-colors @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi') }}</textarea>
